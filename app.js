...
function atcCodeSelect(t){const blocked=blockedAtcForVatCategory(t.vatCategory);return `<select class="select-small mono wp-atc wp-autosave" data-id="${attr(t._id)}" id="wp_atc_${attr(t._id)}">${atcMasterOptions(t.atcCode,blocked)}</select>`}
